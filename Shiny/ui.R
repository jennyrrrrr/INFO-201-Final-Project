...
ui <- shinyUI(fluidPage(
  ...
  navbarPage(
    ...
    tabPanel("Exports and Undernourishment ", sidebarLayout(
      position = "right",
      sidebarPanel(
    ...
    tabPanel("Analysis: Food Success Per Country", sidebarLayout(
      position = "right",
      sidebarPanel(
        "Pictured [left] is a graph of food success per
        ...
        withMathJax(helpText("$$\\frac{\\frac
                                              {Exported Goods($)}
                                              {Imported Goods +
                                              Exported Goods ($)}*100%}
        ...
        plotlyOutput("final_plot", width = 1500, height = 1000)
      )
    )),
    tabPanel(
      "References",
      mainPanel(
        ...
        a("Undernourishment by country",
          href = "https://ourworldindata.org/grapher/prevalence
                       -of-undernourishment"
        ),
        br(),
        ...
        a("Global amount of undernourishment",
          href =
            "https://ourworldindata.org/grapher/global-population
                       -defined-as-undernourished?time=1991..2017"
        ),
        br(),
